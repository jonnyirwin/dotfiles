return {
    ...
    opts = {
        spec = {
            ...
            { "<leader>rr", desc = "Related file navigation" },
            { "<leader>rec", desc = "Edit controller" },
            { "<leader>rev", desc = "Edit view" },
            { "<leader>reh", desc = "Edit helper" },
            { "<leader>rer", desc = "Edit routes.rb" },
            { "<leader>rej", desc = "Edit job" },
            { "<leader>rem", desc = "Edit mailer" },
            { "<leader>rc", desc = "Rails console" },
            { "<leader>rs", desc = "Rails server" },
            { "<leader>rD", desc = "Debug Rails commands" },

            { "<leader>i", group = "💧 IEx/Elixir" },
            { "<leader>iv", desc = "Go to view" },
            { "<leader>ic", desc = "Go to controller" },
            { "<leader>im", desc = "Go to model/schema" },
            { "<leader>it", desc = "Go to test" },
            { "<leader>is", desc = "Go to schema" },
            { "<leader>il", desc = "Go to LiveView" },
            { "<leader>iC", desc = "Go to context" },
            { "<leader>iM", desc = "Go to migration" },
            { "<leader>iR", desc = "Go to router" },
            { "<leader>iE", desc = "Go to endpoint" },
            { "<leader>iV", desc = "Open router file" },
            { "<leader>iZ", desc = "Database structure" },
            
            { "<leader>ix", group = "💻 IEx Terminal" },
            { "<leader>ixc", desc = "IEx console" },
            { "<leader>ixs", desc = "Phoenix server" },
            { "<leader>ixt", desc = "Mix test (stale)" },
            { "<leader>ixl", desc = "LiveBook server" },
