return {
    ...
    opts = {
        ...
        spec = {
            ...
            { "<leader>ls", desc = "✍️  Show signature help" },
            { "<leader>lr", desc = "📚 Show references" },
            { "<leader>lc", desc = "✏️  Rename symbol" },
            { "<leader>la", desc = "⚡ Code actions" },
            { "<leader>lj", desc = "⬇️  Next diagnostic" },
            { "<leader>lk", desc = "⬆️  Previous diagnostic" },
            ...
            { "<leader>bn", desc = "➡️ Next buffer" },
            { "<leader>bp", desc = "⬅️ Previous buffer" },
            { "<leader>bd", desc = "❌ Delete buffer" },

            { "<leader>w", group = "🪟 Window" },
            { "<leader>wv", desc = "⬇️ Split vertically" },
            { "<leader>wh", desc = "➡️ Split horizontally" },
            { "<leader>we", desc = "⚖️ Equalize splits" },
            ...
            { "<leader>an", desc = "➡️  Next tab" },
            { "<leader>ap", desc = "⬅️  Previous tab" },

            { "<leader>r", group = "💎 Rails/Ruby" },
            { "<leader>rv", desc = "🔄 Controller/View toggle" },
            { "<leader>rV", desc = "🛤️ View Rails routes" },
            { "<leader>rS", desc = "🗂️ View database schema" },
            { "<leader>rm", desc = "📊 Go to model" },
            { "<leader>rg", desc = "📈 Go to migration" },
            { "<leader>rt", desc = "⚙️ Run Rake task" },
            ...
            { "<leader>rD", desc = "🐞 Debug RSpec file" },
                        ...
                        { "<leader>e", group = "💧 Elixir/Phoenix" },
            { "<leader>ec", desc = "🎮 Go to controller" },
            { "<leader>em", desc = "📊 Go to model/schema" },
            { "<leader>et", desc = "🧪 Go to test" },
            { "<leader>es", desc = "🗃️ Go to schema" },
            { "<leader>el", desc = "⚡ Go to LiveView" },
            { "<leader>eC", desc = "📦 Go to context" },
            { "<leader>eM", desc = "📈 Go to migration" },
            { "<leader>eR", desc = "🛤️ Go to router" },
            { "<leader>eE", desc = "🔌 Go to endpoint" },
            { "<leader>eV", desc = "🗺️ Open router" },
            { "<leader>eS", desc = "🗂️ Database structure" },
            { "<leader>ef", desc = "🛢️ Open Oil (float)" },
            { "<leader>eh", desc = "➡️ Oil horizontal split" },
            { "<leader>ev", desc = "👁️ Go to view / Oil vertical split" },

            { "<leader>M", group = "🧪 Mix Tasks" },
            { "<leader>Mx", desc = "⚙️ Run Mix task" },
            { "<leader>Mt", desc = "🧪 Run all tests" },
            { "<leader>Mf", desc = "📄 Test current file" },
            { "<leader>Mc", desc = "🔨 Compile" },
            { "<leader>Md", desc = "📦 Get dependencies" },
            { "<leader>Ms", desc = "🚀 Start Phoenix server" },
            { "<leader>Mi", desc = "💻 Start IEx" },
            { "<leader>Mp", desc = "🆕 New Phoenix project" },
            { "<leader>Mg", desc = "⚡ Generate LiveView" },
            { "<leader>Mh", desc = "🌐 Generate HTML context" },
            { "<leader>Mj", desc = "📡 Generate JSON API" },
            { "<leader>Mn", desc = "📈 New migration" },
            { "<leader>Mm", desc = "▶️ Run migrations" },
            { "<leader>Mr", desc = "⏪ Rollback migration" },
            { "<leader>Me", desc = "🔄 Reset database" },

            { "<leader>m", group = "🏹 Motion/Harpoon" },
            { "<leader>ma", desc = "➕ Add to harpoon" },
            { "<leader>mh", desc = "📋 Show harpoon menu" },
            { "<leader>md", desc = "🗄️ Toggle Database UI" },
            ...
            { "<leader>dc", desc = "▶️ Continue debugging" },
            { "<leader>ds", desc = "👣 Step over" },
            { "<leader>di", desc = "⬇️ Step into" },
            { "<leader>do", desc = "⬆️ Step out" },
            { "<leader>dt", desc = "⏹️ Terminate debugging" },
            { "<leader>du", desc = "🖥️ Toggle debug UI" },
            ...
            { "<leader>xh", desc = "➡️ Horizontal terminal" },
            { "<leader>xv", desc = "⬇️ Vertical terminal" },

            { "<leader>e", desc = "🛢️ Open Oil (float)" },
            { "<leader>eh", desc = "➡️ Oil horizontal split" },
            { "<leader>ev", desc = "⬇️ Oil vertical split" },
            ...
            { "<leader>mh", desc = "📋 Show harpoon menu" },
            { "<leader>md", desc = "🗄️ Toggle Database UI" },
            { "<leader>1", desc = "1️⃣ Jump to harpoon 1" },
            { "<leader>2", desc = "2️⃣ Jump to harpoon 2" },
            { "<leader>3", desc = "3️⃣ Jump to harpoon 3" },
            { "<leader>4", desc = "4️⃣ Jump to harpoon 4" },
